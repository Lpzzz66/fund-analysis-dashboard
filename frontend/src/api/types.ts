...
export interface DashboardSeriesPoint { valuation_date: string; company_index: string | null; company_daily_return: string | null; drawdown: string | null; total_net_assets: string | null; effective_fund_count: number; }
export interface DashboardSeries { methodology: string; points: DashboardSeriesPoint[]; }
export interface DashboardSeriesResponse { data: DashboardSeries; meta: { coverage: { available: number; total: number }; start: string | null; end: string | null; max_drawdown: string | null; current_drawdown: string | null }; }
...
export interface FundDetail { id: number; name: string; product_code: string | null; strategy: string | null; manager: string | null; establishment_date: string | null; notes: string | null; aliases: unknown[]; share_classes: unknown[]; status: import("@/utils/constants").FundStatus; current_version_id: number | null; valuation_date: string | null; quality_status: import("@/utils/constants").QualityStatus; analysis_status: string; analysis_run_id: number | null; total_assets: string | null; net_asset_value: string | null; unit_nav: string | null; cumulative_unit_nav: string | null; daily_return: string | null; cumulative_return: string | null; period_returns: { daily: string | null; wtd: string | null; mtd: string | null; qtd: string | null; ytd: string | null; cumulative: string | null }; }
