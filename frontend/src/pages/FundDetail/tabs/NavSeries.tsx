...
export default function NavSeries({ fundId }: { fundId: number }) {
  const [points, setPoints] = useState<NavPoint[]>([]); const [totalReturn, setTotalReturn] = useState<string | null>(null); const [error, setError] = useState<string | null>(null); const toast = useToast();
